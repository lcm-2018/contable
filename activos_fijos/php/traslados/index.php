                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body" id="divCuerpoPag">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-2">
                                    <select class="form-control form-control-sm" id="sl_resori_filtro">
                                        <?php usuarios($cmd, '--Responsable Origen--') ?>
                                    </select>
                                </div>                                
                                <div class="form-group col-md-1">
                                    <input type="text" class="filtro form-control form-control-sm" id="txt_id_traslado_filtro" placeholder="Id. traslado">
                                </div>                                
                                ...
                                <div class="form-group col-md-2">
                                    <select class="form-control form-control-sm" id="sl_resdes_filtro">
                            ...
                            <?php
                            if (PermisosUsuario($permisos, 5708, 2) || $id_rol == 1) {
