...
<div class="px-0">
    <div class="shadow">
        <div class="card-header mb-2" style="background-color: #16a085 !important;">
            <h5 style="color: white;">VER HOJA DE VIDA DE ACTIVO FIJO</h5>
        </div>
        <?php
        if (!empty($obj_hv)) {
            $cmd = null;
        ?>
            <div class="px-2 pt-0" style="overflow-y: scroll;height: 70vh; width: 100%;" id="PrintQR">
                        ...
                        <div id="collapsemodDos" class="collapse" aria-labelledby="modDos">
                            <div class="card-body">
                                <div class="overflow px-1">
                                    <table class="w-100 table-bordered table-sm text-left" style="font-size:85%; white-space: nowrap;">
                                        <tr>
                                            <td class="w-35 text-center" rowspan="14"><img src="<?php echo $ruta_img ?>" alt="equipo"></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="p-0_5">
                                                <div class="form-control form-control-sm altura border-0 rounded-0 "><?php echo $hvgral['lote'] ?></div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="div-gris">Año de fabricación</td>
                                            <td class="p-0_5">
                                                <div class="form-control form-control-sm altura border-0 rounded-0 "><?php echo $hvgral['anio_fab'] ?></div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="div-gris">Registro INVIMA</td>
                                            <td class="px-0_5">
                                                <div class="form-control form-control-sm altura border-0 rounded-0 "><?php echo $hvgral['reg_invima'] ?></div>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-2">
                                                <div class="px-0_5"><?php echo $hvgral['origen'] ?></div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="div-gris">Representante en Colombia</td>
                                            <td class="px-2">
                                                <div class="px-0_5"><?php echo $hvgral['representante'] ?></div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="div-gris">Dirección</td>
                                            <td class="px-2">
                                                <div class="px-0_5"><?php echo $hvgral['direccion'] ?></div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="div-gris">Teléfono</td>
                                            <td class="px-2">
                                                <div class="px-0_5"><?php echo $hvgral['telefono'] ?></div>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                                ...
                                <div class="px-1 overflow">
                                    <table class="w-100 table-bordered table-sm text-left" style="font-size:85%; white-space: nowrap;">
                                        ...
                                        <tr class="div-gris">
                                            ...
                                            <td colspan="2" class="text-center"><input type="radio" disabled name="numFormAdq" value="1" <?php echo $pr ?> class="centro-vertical"></td>
                                            <td colspan="2" class="text-center">Donación</td>
                                            <td colspan="2" class="text-center"><input type="radio" disabled name="numFormAdq" value="2" <?php echo $do ?> class="centro-vertical"></td>
                                            <td colspan="2" class="text-center">Comodato</td>
                                            <td colspan="2" class="text-center"><input type="radio" disabled name="numFormAdq" value="3" <?php echo $ot ?> class="centro-vertical"></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr class="div-gris text-center">
                                            ...
                                            <td colspan="2">I</td>
                                            <td colspan="1"><input type="radio" disabled name="clasRiesgo" value="1" class="centro-vertical"></td>
                                            <td colspan="2">IIA</td>
                                            <td colspan="1"><input type="radio" disabled name="clasRiesgo" value="2" class="centro-vertical"></td>
                                            <td colspan="2">IIB</td>
                                            <td colspan="1"><input type="radio" disabled name="clasRiesgo" value="3" class="centro-vertical"></td>
                                            <td colspan="2">III</td>
                                            <td colspan="1"><input type="radio" disabled name="clasRiesgo" value="4" class="centro-vertical"></td>
                                        </tr>
                                        <tr>
                                                ...
                                                <div class="form-row p-y0">
                                                    ...
                                                    <div class="col-md-8 p-0_5 px-0 text-center">
                                                        <div slider id="slider-distance" class="pt-2">
                                                            ...
                                                            <input type="range" disabled tabindex="0" value="<?php echo $v_min ?>" max="<?php echo $v_max_ref ?>" min="0" step="1" class="valueMin" id="v" />
                                                            <input type="range" disabled tabindex="0" value="<?php echo $v_max ?>" max="<?php echo $v_max_ref ?>" min="0" step="1" class="valueMax" id="v" />
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-row p-y0">
                                                    ...
                                                    <div class="col-md-8 p-0_5 px-0 text-center">
                                                        <div slider id="slider-distance" class="pt-2">
                                                            ...
                                                            <input type="range" disabled tabindex="0" value="<?php echo $hz_min ?>" max="<?php echo $hz_max_ref ?>" min="0" step="1" class="valueMin" id="hz" />
                                                            <input type="range" disabled tabindex="0" value="<?php echo $hz_max ?>" max="<?php echo $hz_max_ref ?>" min="0" step="1" class="valueMax" id="hz" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 text-center p-0_5 w-100">
                                                ...
                                                <div class="form-row p-y0">
                                                    ...
                                                    <div class="col-md-8 p-0_5 px-0 text-center">
                                                        <div slider id="slider-distance" class="pt-2">
                                                            ...
                                                            <input type="range" disabled tabindex="0" value="<?php echo $w_min ?>" max="<?php echo $w_max_ref ?>" min="0" step="1" class="valueMin" id="w" />
                                                            <input type="range" disabled tabindex="0" value="<?php echo $w_max ?>" max="<?php echo $w_max_ref ?>" min="0" step="1" class="valueMax" id="w" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 text-center p-0_5 w-100">
                                                ...
                                                <div class="form-row p-y0">
                                                    ...
                                                    <div class="col-md-8 p-0_5 px-0 text-center">
                                                        <div slider id="slider-distance" class="pt-2">
                                                            ...
                                                            <input type="range" disabled tabindex="0" value="<?php echo $ma_min ?>" max="<?php echo $ma_max_ref ?>" min="0" step="1" class="valueMin" id="mA" />
                                                            <input type="range" disabled tabindex="0" value="<?php echo $ma_max ?>" max="<?php echo $ma_max_ref ?>" min="0" step="1" class="valueMax" id="mA" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 text-center p-0_5 w-100">
                                                ...
                                                <div class="form-row p-y0">
                                                    ...
                                                    <div class="col-md-8 p-0_5 px-0 text-center">
                                                        <div slider id="slider-distance" class="pt-2">
                                                            ...
                                                            <input type="range" disabled tabindex="0" value="<?php echo $gc_min ?>" max="<?php echo $gc_max_ref ?>" min="0" step="1" class="valueMin" id="gC" />
                                                            <input type="range" disabled tabindex="0" value="<?php echo $gc_max ?>" max="<?php echo $gc_max_ref ?>" min="0" step="1" class="valueMax" id="gC" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 text-center p-0_5 w-100">
                                ...
                                <div class="overflow px-1">
                                    <table class="w-100 table-bordered table-sm text-left" style="font-size:85%; white-space: nowrap;">
                                        ...
                                        <tr class="div-gris text-center">
                                            ...
                                            <td colspan="2"><input type="radio" disabled name="riesgoApoyoTec" value="1" class="centro-vertical" <?php echo $r1 ?>></td>
                                            <td colspan="3">Medio</td>
                                            <td colspan="2"><input type="radio" disabled name="riesgoApoyoTec" value="2" class="centro-vertical" <?php echo $r2 ?>></td>
                                            <td colspan="3">Bajo</td>
                                            <td colspan="2"><input type="radio" disabled name="riesgoApoyoTec" value="3" class="centro-vertical" <?php echo $r3 ?>></td>
                                        </tr>
                                        <tr class="div-gris text-center">
                                            <td colspan="5" class="text-left">Uso</td>
                                            <td colspan="3">Médico</td>
                                            <td colspan="2"><input type="radio" disabled name="usoApoyoTec" value="1" class="centro-vertical" <?php echo $u1 ?>></td>
                                            <td colspan="3">Básico</td>
                                            <td colspan="2"><input type="radio" disabled name="usoApoyoTec" value="2" class="centro-vertical" <?php echo $u2 ?>></td>
                                            <td colspan="3">Apoyo</td>
                                            <td colspan="2"><input type="radio" disabled name="usoApoyoTec" value="3" class="centro-vertical" <?php echo $u3 ?>></td>
                                        </tr>
                                        <tr>
                                            <td colspan="6" rowspan="5" class="div-gris">Clasificación biomédica</td>
                                            <td colspan="5" class="text-left div-gris">Diagnóstico</td>
                                            <td colspan="9" class="p-0_5">
                                                <div class="form-control form-control-sm altura border-0 rounded-0"><?php echo $diagnostico ?></div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="5" class="text-left div-gris">Prevención</td>
                                            <td colspan="9" class="p-0_5">
                                                <div class="form-control form-control-sm altura border-0 rounded-0"><?php echo $prevencion ?></div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="5" class="text-left div-gris">Rehabilitación</td>
                                            <td colspan="9" class="p-0_5">
                                                <div class="form-control form-control-sm altura border-0 rounded-0"><?php echo $rehabilitacion ?></div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="5" class="text-left div-gris">Análisis de laboratorio</td>
                                            <td colspan="9" class="p-0_5">
                                                <div class="form-control form-control-sm altura border-0 rounded-0"><?php echo $analis_lab ?></div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="5" class="text-left div-gris">Tratamiento y mantenimiento de la vida</td>
                                            <td colspan="9" class="p-0_5">
                                                <div class="form-control form-control-sm altura border-0 rounded-0"><?php echo $tratamiento ?></div>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                                ...
                                <div class="overflow px-1">
                                    <table class="w-100 table-bordered table-sm text-left" style="font-size:85%; white-space: nowrap;">
                                        ...
                                        <tr>
                                            ...
                                            <td class="w-10 div-gris text-center"><input type="radio" disabled name="instalPlano" value="1" class="centro-vertical" <?php echo $i1 ?>></td>
                                            <td class="w-10 div-gris text-center"><input type="radio" disabled name="instalPlano" value="2" class="centro-vertical" <?php echo $i2 ?>></td>
                                            <td class="w-10 div-gris text-center"><input type="radio" disabled name="instalPlano" value="3" class="centro-vertical" <?php echo $i3 ?>></td>
                                            <td class="w-45 p-0_5">
                                                <div class="form-row">
                                                    <div class="col-md-10">
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="w-10 div-gris text-center"><input type="radio" disabled name="partePlano" value="1" class="centro-vertical" <?php echo $p1 ?>></td>
                                            <td class="w-10 div-gris text-center"><input type="radio" disabled name="partePlano" value="2" class="centro-vertical" <?php echo $p2 ?>></td>
                                            <td class="w-10 div-gris text-center"><input type="radio" disabled name="partePlano" value="3" class="centro-vertical" <?php echo $p3 ?>></td>
                                            <td class="w-45 p-0_5">
                                                <div class="form-row">
                                                    <div class="col-md-10">
                                                    </div>
                                ...
                                <div class="overflow px-1">
                                    <table class="w-100 table-bordered table-sm text-left" style="font-size:85%; white-space: nowrap;">
                                        ...
                                        <tr>
                                            ...
                                            <td class="w-10 div-gris text-center"><input type="radio" disabled name="servTecManual" value="1" class="centro-vertical" <?php echo $mst1 ?>></td>
                                            <td class="w-10 div-gris text-center"><input type="radio" disabled name="servTecManual" value="2" class="centro-vertical" <?php echo $mst2 ?>></td>
                                            <td class="w-10 div-gris text-center"><input type="radio" disabled name="servTecManual" value="3" class="centro-vertical" <?php echo $mst3 ?>></td>
                                            <td class="w-45 p-0_5">
                                                <div class="form-row">
                                                    <div class="col-md-10">
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="w-10 div-gris text-center"><input type="radio" disabled name="userManual" value="1" class="centro-vertical" <?php echo $mu1 ?>></td>
                                            <td class="w-10 div-gris text-center"><input type="radio" disabled name="userManual" value="2" class="centro-vertical" <?php echo $mu2 ?>></td>
                                            <td class="w-10 div-gris text-center"><input type="radio" disabled name="userManual" value="3" class="centro-vertical" <?php echo $mu3 ?>></td>
                                            <td class="w-45 p-0_5">
                                                <div class="form-row">
                                                    <div class="col-md-10">
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="w-10 div-gris text-center"><input type="radio" disabled name="guiaFastManual" value="1" class="centro-vertical" <?php echo $mf1 ?>></td>
                                            <td class="w-10 div-gris text-center"><input type="radio" disabled name="guiaFastManual" value="2" class="centro-vertical" <?php echo $mf2 ?>></td>
                                            <td class="w-10 div-gris text-center"><input type="radio" disabled name="guiaFastManual" value="3" class="centro-vertical" <?php echo $mf3 ?>></td>
                                            <td class="w-45 p-0_5">
                                                <div class="form-row">
                                                    <div class="col-md-10">
                                                    </div>
                        ...
                        <div id="collapsemodNueve" class="collapse" aria-labelledby="modNueve">
                            <div class="card-body">
                                <div class="form-row px-1">
                                    <div class="col-md-12">
                                        <textarea readonly class="form-control form-control-sm rounded-0" id="txtaReCons" rows="5"><?php echo $obj_hv['recomendaciones'] ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="overflow px-1">
                                    <table class="w-100 table-sm text-left" style="font-size:85%; white-space: nowrap;">
                                        <tr class="div-gris text-center">
                                            ...
                                            <td class="w-10 border"><input type="radio" disabled name="estadoGral" value="1" class="centro-vertical" <?php echo $obj_hv['estado'] == 1 ? 'checked' : '' ?>></td>
                                            <td class="w-15 border">Regular</td>
                                            <td class="w-10 border"><input type="radio" disabled name="estadoGral" value="2" class="centro-vertical" <?php echo $obj_hv['estado'] == 2 ? 'checked' : '' ?>></td>
                                            <td class="w-15 border">Malo</td>
                                            <td class="w-10 border"><input type="radio" disabled name="estadoGral" value="3" class="centro-vertical" <?php echo $obj_hv['estado'] == 3 ? 'checked' : '' ?>></td>
                                        </tr>
                                        ...
                                        <tr class="border border-top-0">
                                            <td colspan="7" class="p-0_5"><textarea readonly id="txtaEstadoGral" name="txtaEstadoGral" class="form-control form-control-sm border-0 rounded-0" rows="5"><?php echo $obj_hv['mmto_causas'] ?></textarea></td>
                                        </tr>
                                    </table>
                                ...
                                <div class="overflow px-1">
                                    <table class="w-100 table-sm text-left" style="font-size:85%; white-space: nowrap;">
                                        <tr class="div-gris text-center">
                                            ...
                                            <td class="w-15 border">Bueno</td>
                                            <td class="w-10 border"><input type="radio" disabled name="estadoFunca" value="1" class="centro-vertical" <?php echo $funcionamiento['estado'] == 1 ? 'checked' : '' ?>></td>
                                            <td class="w-15 border">Regular</td>
                                            <td class="w-10 border"><input type="radio" disabled name="estadoFunca" value="2" class="centro-vertical" <?php echo $funcionamiento['estado'] == 2 ? 'checked' : '' ?>></td>
                                            <td class="w-15 border">Malo</td>
                                            <td class="w-10 border"><input type="radio" disabled name="estadoFunca" value="3" class="centro-vertical" <?php echo $funcionamiento['estado'] == 3 ? 'checked' : '' ?>></td>
                                        </tr>
                                        <tr class="text-center">
                                            <td class="div-gris border">Fuera de Servicio</td>
                                            <td class="div-gris border"><input type="radio" disabled name="estadoFunca" value="4" class="centro-vertical" <?php echo $funcionamiento['estado'] == 4 ? 'checked' : '' ?>></td>
                                            <td class="div-gris border">Años fuera de servicio</td>
                                            <td colspan="3" class="p-0_5 border">
                                                <div class="form-control form-control-sm altura border-0 rounded-0 text-left"><?php echo $funcionamiento['anios_fuera_servicio'] ?></div>
                                            </td>
                                        </tr>
                                        <tr class="border border-bottom-0">
                                        ...
                                        <tr class="border border-top-0">
                                            <td colspan="7" class="p-0_5"><textarea readonly class="form-control form-control-sm border-0 rounded-0" id="txtaFuncionamiento" name="txtaFuncionamiento" rows="5"><?php echo $funcionamiento['causas'] ?></textarea></td>
                                        </tr>
                                    </table>
                                        ...
                                        <table class="w-100 table-bordered table-sm text-left" style="font-size:85%; white-space: nowrap;">
                                            ...
                                            foreach ($lismmtos as $lm) { ?>
                                                <tr>
                                                    ...
                                                    <td class="p-0_5">
                                                        <textarea readonly class="form-control form-control-sm border-0 rounded-0" style="height: 27px;" readonly><?php echo $lm['descripcion'] ?></textarea>
                                                    </td>
                                                    <td class="px-2">
        ...
        <?php
            ...
            echo '<div class="alert alert-warning">Error al obtener datos<br>' . $cmd->errorInfo()[2];
            echo '1. Comprobar conexión a la base de datos<br>';
            echo '2. Comprobar que el activo fijo tenga un traslado a un centro de costo</div>';
            $cmd = null;
        }
        ?>
