(function($) {
    ...
    $('#divForms').on("change", "#sl_bodega_solicitante", function() {
        $('#id_bodega_solicitante').val($('#sl_bodega_solicitante').val());
    });
    ...
    $('#divForms').on("click", "#btn_guardar", function() {
        ...
        var error = verifica_vacio_2($('#id_sede_proveedor'), $('#txt_sede_proveedor'));
        error += verifica_vacio_2($('#id_bodega_proveedor'), $('#txt_bodega_proveedor'));        
        error += verifica_vacio($('#sl_sede_solicitante'));
        ...
        if (error >= 1) {
            ...
            if ($('#id_bodega_solicitante').val() == $('#id_bodega_proveedor').val()) {
                $('#divModalError').modal('show');
    ...
    $('#divFormsReg').on("click", "#btn_guardar_detalle", function() {
        ...
        if (error >= 1) {
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: data + "&id_pedido=" + $('#id_pedido').val() + "&id_bodega=" + $('#id_bodega_proveedor').val() + '&oper=add'
            }).done(function(r) {
                if (r.mensaje == 'ok') {
