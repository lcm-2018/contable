...
try {
    ...
    if ((PermisosUsuario($permisos, 5005, 2) && $oper == 'add' && $_POST['id_detalle'] == -1) ||
        (PermisosUsuario($permisos, 5005, 3) && $oper == 'add' && $_POST['id_detalle'] != -1) ||
        (PermisosUsuario($permisos, 5005, 4) && $oper == 'del') || $id_rol == 1) {
