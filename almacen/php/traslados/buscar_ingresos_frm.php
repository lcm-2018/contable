...
<div class="px-0">
    <div class="shadow">
        <div class="card-header mb-3" style="background-color: #16a085 !important;">
            <h7 style="color: white;">INGRESOS DE ALMACEN</h7>
        </div>
        <div class="px-2">

            <!--Formulario de busqueda de articulos-->
            <form id="frm_buscar_ingidos">
                <div class="form-row">
                    <div class="form-group col-md-2">
                        <input type="text" class="filtro_ing form-control form-control-sm" id="txt_num_ing_fil" placeholder="No. Ingreso">
                    </div>
                    <div class="form-group col-md-3">
                        <input type="date" class="filtro_ing form-control form-control-sm" id="txt_fecini_fil" name="txt_fecini_fil" placeholder="Fecha Inicial">
                    </div>
                    <div class="form-group col-md-3">
                ...
                <table id="tb_ingresos_tra" class="table table-striped table-bordered table-sm nowrap table-hover shadow" style="width:100%; font-size:80%">
                    <thead>
                        <tr class="text-center centro-vertical">
                            <th rowspan="2">Id</th>
                            <th rowspan="2">No. Ingreso</th>
                            <th rowspan="2">Fecha Ingreso</th>
                            <th rowspan="2">Detalle</th>                                                                    
                            <th colspan="4">Unidad Origen</th>
                            <th rowspan="2">Ver</th>
                        </tr>
                        <tr class="text-center centro-vertical">
                            <th>Id.Sede</th>
