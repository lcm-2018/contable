...
$sql = "SELECT TT.fec_traslado,TT.hor_traslado,TT.num_traslado,TT.tipo,
            TT.id_sede_origen,SP.nom_sede AS nom_sede_origen,
            TT.id_bodega_origen,BP.nombre AS nom_bodega_origen,
            TT.id_sede_destino,TT.id_bodega_destino,
...
<div class="px-0">
    <div class="shadow">
        <div class="card-header mb-3" style="background-color: #16a085 !important;">
            <h5 style="color: white;">REGISTRAR TRASLADO SPSR</h5>
        </div>
        <div class="px-2">
            ...
            <form id="frm_reg_traslados">
                ...
                <div class="form-row">                    
                    <div class="form-group col-md-3">
                        <label for="txt_sede_origen" class="small">Sede Principal</label>
                        <input type="text" class="form-control form-control-sm" id="txt_sede_origen" class="small" value="<?php echo $obj['nom_sede_origen'] ?>" readonly="readonly">
                        <input type="hidden" id="id_sede_origen" name="id_sede_origen" value="<?php echo $obj['id_sede_origen'] ?>">
                    </div>
                    <div class="form-group col-md-3">
                        <label for="txt_bodega_origen" class="small">Bodega Principal</label>
                        <input type="text" class="form-control form-control-sm" id="txt_bodega_origen" class="small" value="<?php echo $obj['nom_bodega_origen'] ?>" readonly="readonly">
    ...
    <div class="text-center pt-3">
        ...
        <button type="button" class="btn btn-primary btn-sm" id="btn_cerrar" <?php echo $cerrar ?>>Cerrar-Egresar</button>
        <button type="button" class="btn btn-primary btn-sm" id="btn_enviar" <?php echo $enviar ?>>Enviar</button>
