...
$titulo = '';
 switch($id_reporte){
    case '1':
        $titulo = 'REPORTE DE EGRESOS ENTRE:' . $_POST['fec_ini'] . ' y ' .  $_POST['fec_fin'] . ', TOTALIZADOS POR TIPO DE EGRESO-DESTINO-SUBGRUPO';
        break;
} 
...
try {
    ...
    $sql = "SELECT tb_centrocostos.id_centro,far_centrocosto_area.id_area,
                IF(far_centrocosto_area.id_area=0,tb_centrocostos.nom_centro,CONCAT_WS('-',far_centrocosto_area.nom_area,tb_sedes.nom_sede)) AS nom_area,
            ...
            GROUP BY tb_centrocostos.id_centro,far_centrocosto_area.id_area,tb_terceros.id_tercero
            ORDER BY far_centrocosto_area.nom_area,tb_terceros.nom_tercero";
    ...
    $sql = "SELECT far_subgrupos.id_subgrupo,CONCAT_WS(' - ',far_subgrupos.cod_subgrupo,far_subgrupos.nom_subgrupo) AS nom_subgrupo,                
            ...
            $where AND far_orden_egreso.id_tipo_egreso=:id_tipo_egreso AND far_orden_egreso.id_cliente=:id_tercero
                   AND far_orden_egreso.id_centrocosto=:id_centro AND far_orden_egreso.id_area=:id_area
    ...
    <table style="width:100% !important">        
        <tbody style="font-size: 60%;">
            ...
            switch($id_reporte){
                case '1':
                    $tabla = '<tr style="background-color:#CED3D3; text-align:center">
                        <th>Area-Centro de Costo</th><th>Tercero</th><th>Vr. Parcial</th><th>Vr. Total</th></tr>';
                    break; 
            }
            ...
            foreach ($objs as $obj1) {
                ...
                $tabla .= '<tr><th colspan="3" style="text-align:left">TIPO DE EGRESO: ' . mb_strtoupper($obj1['nom_tipo_egreso']) . '</th>
                ...
                foreach ($objt as $obj2) {
                    ...
                    $id_area = $obj2['id_area'];
                    $id_tercero = $obj2['id_tercero'];
                
                    $tabla .= '<tr><th style="text-align:left">' . mb_strtoupper($obj2['nom_area']) . '</th>
                    ...
                    $rs_d->bindParam(':id_area',$id_area);
                    ...
                    foreach ($objd as $obj) {
                        $tabla .=  '<tr class="resaltar">                                                                                 
                            <td colspan="2" style="text-align:left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' . mb_strtoupper($obj['nom_subgrupo']) . '</td>
