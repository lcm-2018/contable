...
<div class="px-0">
    <div class="shadow">
        <div class="card-header mb-3" style="background-color: #16a085 !important;">
            <h7 style="color: white;">REGISRTAR DETALLE EN ORDEN DE EGRESO</h7>
        </div>
        <div class="px-2">
            ...
            <form id="frm_reg_egresos_detalles">
                ...
                <div class=" form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="number" class="form-control form-control-sm numberint" id="txt_can_egr" name="txt_can_egr" value="<?php echo $obj['cantidad'] ?>">
                    </div>
                    <div class="form-group col-md-3">
