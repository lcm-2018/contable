...
<body class="sb-nav-fixed <?php if ($_SESSION['navarlat'] == '1') {
                        ...
                        <div class="card-body" id="divCuerpoPag">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-1">
                                    ...
                                    <button id="btnImprimeEgresos" class="btn btn-outline-success btn-sm" title="Imprimir Egresos"><i class="fas fa-print"></i></button>
                                </div>
                            </div>
    ...
    <script type="text/javascript" src="../../js/egresos/egresos.js?v=<?php echo date('YmdHis') ?>"></script>
</body>
