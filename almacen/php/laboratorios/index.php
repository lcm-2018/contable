...
<body class="sb-nav-fixed <?php if ($_SESSION['navarlat'] == '1') {
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body" id="divCuerpoPag">
                            ...
                            <!--Lista de registros en la tabla
                                5001-Opcion [General][laboratorios]
                                1-Consultar, 2-Adicionar, 3-Modificar, 4-Eliminar, 5-Anular, 6-Imprimir
                            -->
                            <?php
                            if (PermisosUsuario($permisos, 5001, 2) || $id_rol == 1) {
                                echo '<input type="hidden" id="peReg" value="1">';
                            } else {
                                echo '<input type="hidden" id="peReg" value="0">';
                            }
                            ?>
                            <table id="tb_laboratorios" class="table table-striped table-bordered table-sm nowrap table-hover shadow" style="width:100%; font-size:80%">
                                <thead>
    ...
    <script type="text/javascript" src="../../js/laboratorios/laboratorios.js?v=<?php echo date('YmdHis') ?>"></script>
</body>
