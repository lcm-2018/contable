...
<div class="px-0">
    <div class="shadow">
        <div class="card-header mb-3" style="background-color: #16a085 !important;">
            <h5 style="color: white;">REGISRTAR LABORATORIO</h5>
        </div>
        <div class="px-2">
            <form id="frm_reg_laboratorios">
                ...
                <div class=" form-row">
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control form-control-sm" id="txt_nom_laboratorio" name="txt_nom_laboratorio" required value="<?php echo $obj['nom_laboratorio'] ?>">
                    </div>
                </div>
            </form>
        </div>
