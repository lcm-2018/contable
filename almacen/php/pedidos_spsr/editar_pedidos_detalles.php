...
try {
    ...
    if ((PermisosUsuario($permisos, 5018, 2) && $oper == 'add' && $_POST['id_detalle'] == -1) ||
        (PermisosUsuario($permisos, 5018, 3) && $oper == 'add' && $_POST['id_detalle'] != -1) ||
        (PermisosUsuario($permisos, 5018, 4) && $oper == 'del') || $id_rol == 1) {
