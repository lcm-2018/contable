    ...
    <table style="width:100% !important">       
        <tbody style="font-size: 60%;">
            ...
            foreach ($objs as $obj1) {
                ...
                $tabla .= '<tr><th colspan="9" style="text-align:left">' . strtoupper($obj1['nom_sede'] . ' - ' . $obj1['nom_bodega']) . '</th><th>' . formato_valor($obj1['val_total_sb']) . '</th></tr>';
                ...
                foreach ($objg as $obj2) {
                    ...
                    $tabla .= '<tr><th colspan="8" style="text-align:left">' . strtoupper($obj2['nom_subgrupo']) . '</th><th>' . formato_valor($obj2['val_total_sg']) . '</th></tr>';
