                        ...
                        <div class="card-body" id="divCuerpoPag">
                            <div class="container full-height d-flex">
                                <div class="text-center text-muted w-100">
                                    ...
                                    <div class="row w-100" style="padding: 2%;">
                                        <div class="col-md-12 align-middle">
                                            <center><img src="<?php echo $url ?>/images/logoFinanciero.png" class="img-fluid" alt="Imagen 1"></center>
                                        </div>
                                        <div class="row w-100" style="padding: 2%;">
                                            <div class=" col-md-12 align-middle">
                                                <center><img src="<?php echo $url ?>/images/logos/logo.png" class="img-fluid" alt="Imagen 2" style="max-height: 200px;"></center>
                                            </div>
                                        </div>
                                    </div>
                                </div>
