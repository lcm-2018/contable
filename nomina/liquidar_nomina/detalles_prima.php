...
try {
    ...
    $sql = "SELECT nom_empleado.id_empleado, no_documento, CONCAT(nombre1, ' ',nombre2, ' ',apellido1, ' ', apellido2) AS nombre, cant_dias, val_liq_ps
            FROM
                nom_liq_prima
...
$encab = $_SESSION['caracter'] == 1 ? 'PERIODO ' . $periodo  : 'DE SERVICIO';
?>
<!DOCTYPE html>
<html lang="es">
                        ...
                        <div class="card-header" id="divTituloPag">
                            <div class="row">
                                <div class="col-md-11">
                                    ...
                                    LISTA DE EMPLEADOS LIQUIDADO PRIMA <?php echo $encab ?>
                                </div>
                            </div>
                        </div>
