...
try {
    ...
    $sql = "SELECT 
                `nom_empleado`.`id_empleado`, `no_documento`, CONCAT_WS(' ', `nombre1`, `nombre2`, `apellido1`, `apellido2`) AS `nombre`, `cant_dias`, `val_cesantias`, `val_icesantias`
            FROM
                `nom_liq_cesantias`
                        ...
                        <div class="card-header" id="divTituloPag">
                            <div class="row">
                                <div class="col-md-11">
                                    ...
                                    LISTA DE EMPLEADOS LIQUIDACIÓN CENSATÍAS E INTERESES.
                                </div>
                            </div>
                        </div>
                        <div class="card-body" id="divCuerpoPag">
                                ...
                                <table id="dataTable" class="table table-striped table-bordered table-sm table-hover nowrap" style="width:100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Val. Cesantías</th>
                                            <th class="text-center">Val. Interes</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php foreach ($obj as $o) { ?>
                                            <tr>
                                                ...
                                                <td class="text-right"><?php echo pesos($o['val_icesantias']) ?></td>
                                                <td class="text-right"><?php echo pesos($o['val_cesantias']) ?></td>
                                            </tr>
                                        <?php }
                                        ?>
                                    </tbody>
                            ...
                            <div class="center-block py-2">
                                <div class="form-group">
                                    <a type="button" class="btn btn-secondary" href="listempliquidar.php?mes=12"> Regresar</a>
