...
try {
    ...
    */
    ...
    $sql = "SELECT
                ...
                , pto_cdp.objeto
                , pto_crp_detalle.valor AS vrcrp 
                ...
                , (SUM(pto_cdp_detalle2.valor) - SUM(IFNULL(pto_cdp_detalle2.valor_liberado,0))) - (SUM(pto_crp_detalle.valor) - SUM(IFNULL(pto_crp_detalle.valor_liberado,0))) AS saldo
            FROM
                pto_cdp
            ...
            INNER JOIN pto_crp_detalle ON (pto_crp_detalle.id_pto_crp = pto_crp.id_pto_crp)  
