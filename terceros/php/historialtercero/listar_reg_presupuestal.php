...
try {
    ...
    $sql = "WITH
                ...
                -- <-- aquí estamos agregando cop_sum con SUM para que sume todos los id_pto_crp_det del grupo
                SUM(IFNULL(cop_sum.vr_cop, 0)) AS vr_cop,
                SUM(IFNULL(cop_sum.vr_cop_liberado, 0)) AS vr_cop_liberado,
