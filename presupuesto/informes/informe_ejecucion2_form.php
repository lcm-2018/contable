...
<div class="row justify-content-center">
    <div class="col-sm-12 ">
        <div class="card">
            <h5 class="card-header small">EJECUCIÓN</h5>
            <div class="card-body">
                <form>
                    <div class="row mb-2">
                        <div class="col-2"></div>
                        ...
                        <div class="col-3">
                            <select name="tipo_pto" id="tipo_pto" class="form-control form-control-sm">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-3">
                            <select name="fecha" id="fecha" class="form-control form-control-sm">
                                <option value="0">--Seleccionar--</option>
                    ...
                    <div class="text-center">
                        <button value="6" class="btn btn-primary" onclick="generarInforme(this);"><span></span> Consultar</button>
