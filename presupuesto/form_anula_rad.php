...
try {
    ...
    $sql = "SELECT `id_manu` FROM `pto_rad` WHERE `id_pto_rad` = $id";
    $rs = $cmd->query($sql);
    $numero = $rs->fetch();
...
<div class="px-0">
    <form id="formAnulaDoc">
        <input type="hidden" id="id_pto_rad" name="id_pto_rad" value="<?php echo $id; ?>">
        ...
        <div class="text-right">
            <button type="button" class="btn btn-primary btn-sm" onclick="changeEstadoAnulacionRad()">Anular</button>
