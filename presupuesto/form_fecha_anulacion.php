...
try {
    $sql = "SELECT max(id_pto_anula) as id_pto_anula from pto_anula";
    $rs = $cmd->query($sql);
    $row = $rs->fetch();
    $id_pto_anula = $row['id_pto_anula'] + 1;
} catch (PDOException $e) {
    echo $e->getCode() == 2002 ? 'Sin Conexión a Mysql (Error: 2002)' : 'Error: ' . $e->getCode();
}
?>
<div class="px-0">
    <form id="formAnulacionCrpp">
        <div class="shadow mb-3">
            <div class="card-header" style="background-color: #16a085 !important;">
                <h6 style="color: white;"><i class="fas fa-lock fa-lg" style="color: #FCF3CF"></i>&nbsp;ANULACION DE DOCUMENTO PRESUPUESTAL</h5>
            </div>
            <div class="pt-3 px-3">
                <div class="row">
                    <div class="col-3">
                    ...
                    <div class="col-4">
                        <div class="col">
                            <input type="text" id="numero" class="form-control form-control-sm" name="numero" value="<?php echo $id_pto_anula; ?>" readonly>
                            <input type="hidden" id="id_pto_doc" name="id_pto_doc" value="<?php echo $id_pto_doc; ?>">
                        </div>
                    </div>
                </div>
                <div class="row">
