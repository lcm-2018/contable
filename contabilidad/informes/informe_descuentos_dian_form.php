                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="text-center pt-3">
                                <a type="button" class="btn btn-primary btn-sm" onclick="generarInformeCtb(4);"> Resumen</a>
                                <a type="button" class="btn btn-warning btn-sm" onclick="generarInformeCtb(5);"> Detallado</a>
                            </div>
                        </div>
                    </div>
            </div>
