...
<script>
    ...
    $('#tablaCentroCostoCXP').wrap('<div class="overflow" />');
</script>
<div class="px-0">
    <div class="shadow">
        ...
        <div class="p-3">
            <div class="form-row">
                <div class="col-md-2 text-right" title="Centros de costo">
                    <span class="small">Centro Costo:</span>
                </div>
                <div class="form-group col-md-10">
                    <div class="input-group input-group-sm">
                        <input type="text" class="form-control" placeholder="Recipient's username" aria-label="Recipient's username with two button addons" aria-describedby="button-addon4">
                        <div class="input-group-append" id="button-addon4">
                            <button class="btn btn-outline-warning" onclick="cargaCentrosCosto('<?php echo $id_doc; ?>')"><span class="fas fa-eye fa-lg"></button>
                            <button class="btn btn-outline-primary" onclick="consultaCentrosCosto()"><span class="fas fa-hospital-user fa-lg"></button>
                            <button class="btn btn-outline-success" onclick="ajustarCausacionCostos('<?php echo $id_doc; ?>')"><span class="far fa-edit fa-lg"></button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="px-3">
            <table id="tablaCentroCostoCXP" class="table table-striped table-bordered nowrap table-sm table-hover shadow" style="width: 100%;">
                <thead>
                    <tr>
                        <th>Num</th>
                        <th>Rp</th>
