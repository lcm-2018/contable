...
try {
    $sql = "SELECT max(id_manu_anula) as id_manu_anula from seg_ctb_anula WHERE id_modulo =6";
    $rs = $cmd->query($sql);
    $row = $rs->fetch();
    ...
    <form id="formAnulacionCrpp">
        <div class="shadow mb-3">
            <div class="card-header" style="background-color: #16a085 !important;">
                <h6 style="color: white;"><i class="fas fa-lock fa-lg" style="color: #FCF3CF"></i>&nbsp;ANULACION DE DOCUMENTO TESORERIA</h5>
            </div>
            <div class="pt-3 px-3">
                <div class="row">
                    <div class="col-3">
                    ...
                    <div class="col-4">
                        <div class="col">
                            ...
                            <input type="hidden" id="id_ctb_doc" name="id_ctb_doc" value="<?php echo $id_ctb_doc; ?>">
                            <input type="hidden" id="id_modulo" name="id_modulo" value="<?php echo 6; ?>">
                        </div>
                    </div>
                </div>
                <div class="row">
